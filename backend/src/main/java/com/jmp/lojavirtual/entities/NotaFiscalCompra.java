...
public class NotaFiscalCompra {
	...
	@ManyToOne // muitas notas fiscais para uma pessoa
	...
	public NotaFiscalCompra(Long id, String numeroNota, String serieNota, String descricao, BigDecimal valorTotal,
